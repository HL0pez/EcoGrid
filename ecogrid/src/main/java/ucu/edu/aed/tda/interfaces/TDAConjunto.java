 ...
 *
 * <p>
 * Un conjunto es una colección de elementos sin duplicados, donde
 * no importa el orden de almacenamiento.
 * </p>
 *
 * <p>
 * Las operaciones principales permiten agregar, remover, consultar
...
public interface TDAConjunto<T> extends TDALista<T> {
     ...
     *
     * <p>
     * El resultado contiene los elementos que pertenecen a este conjunto
     * pero no al conjunto dado.
     * </p>
     *
     * @param otro el otro conjunto
     ...
     *
     * @param otro el otro conjunto
     * @return {@code true} si todos los elementos de este conjunto pertenecen
     *         también a {@code otro};
